...
class Blood extends State {
    ...
    constructor(obj) {
        super(Blood.getClass(), [obj.DIN, obj.type]);
    ...
    */
     ...
     */
    static createInstance(DIN, mm, type, date, expired, test, donorID, temperature, timeStamp, ownerID) {
        return new Blood({ DIN, mm, type, date, expired, test, donorID, temperature,timeStamp, ownerID,location: LOCATION.BLOOD_BANK, patientID: 'NONE', currentState: DINSTATE.READY});
    }
